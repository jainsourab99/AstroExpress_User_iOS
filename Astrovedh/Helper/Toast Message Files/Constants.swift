...
struct Colors {
    ...
    static let usedOrange       = UIColor(red: 218/255, green: 81/255, blue: 29/255, alpha: 1)
    static let yellow           = UIColor(red: 237/255, green: 217/255, blue: 159/255, alpha: 1)
    
    static let lottleWhite   = UIColor(red: 255/255, green: 153/255, blue: 204/255, alpha: 1)
